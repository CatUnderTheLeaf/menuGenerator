...
source.include_exts = py,png,jpg,kv,atlas,db,json,yml,mo,po
...
requirements = python3,pillow,kivy,kivymd,plyer,Babel,Cython,unqlite,sortedcontainers,typish,jsons,android
